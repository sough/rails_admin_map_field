module RailsAdmin::Config::Fields::Types
  class Showmap < RailsAdmin::Config::Fields::Base
    RailsAdmin::Config::Fields::Types::register(:showmap, self)
    ...
    def dom_name
      @dom_name ||= "#{bindings[:view].object_name}_#{@name}_#{longitude_field}"
    end

    def latitude_dom_name
      @lat_dom_name ||= "#{bindings[:view].object_name}_#{@name}"
    end

    def longitude_dom_name
      @lon_dom_name ||= "#{bindings[:view].object_name}_#{longitude_field}"
    end
  end
end
